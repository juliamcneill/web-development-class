...
if (hour <= 5) {
  ...
  document.write('<img class="scene" src="images/javascript1/night.png">')
} else if (hour <= 11) {
  var timeOfDay = 'Good morning!';
  document.write('<img class="scene" src="images/javascript1/morning.png">')
} else if (hour <= 16) {
  var timeOfDay = 'Good afternoon!';
  document.write('<img class="scene" src="images/javascript1/afternoon.png">')
} else {
  var timeOfDay = 'Good evening!';
  document.write('<img class="scene" src="images/javascript1/evening.png">')
}
...
for (var i = 0; i < 1000; ) {
  ...
  for (var j = 0; j < randoms[0]; j++) {
    document.write('<img class="block" src="images/javascript1/block1.png">');
  }
  for (var j = 0; j < randoms[1]; j++) {
    document.write('<img class="block" src="images/javascript1/block2.png">');
  }
  for (var j = 0; j < randoms[2]; j++) {
    document.write('<img class="block" src="images/javascript1/block3.png">');
  }
}
...
document.write('<img class="body" src="images/javascript1/body' + numbers[bodyindex] + '.png">');

let stripeindex = parseInt(Math.random() * numbers.length);
document.write('<img class="stripe" src="images/javascript1/stripe' + numbers[stripeindex] + '.png">');

let headindex = parseInt(Math.random() * numbers.length);
document.write('<img class="head" src="images/javascript1/head' + numbers[headindex] + '.png">');

let hatindex = parseInt(Math.random() * numbers.length);
document.write('<img class="hat" src="images/javascript1/hat' + numbers[hatindex] + '.png">');
